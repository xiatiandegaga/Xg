...
namespace Domain.Service
{
    public class AuthenticationPrincipalService : IAuthenticationPrincipalService
    {
        ...
        public AuthenticationPrincipalService(IHttpContextAccessor httpContextAccessor, IConfiguration configuration, ICacheRepository<User> cacheUserRepository, ICache cache)
        {
        ...
        /// 注销
        /// </summary>
        public void SignOut() => _httpContextAccessor.HttpContext.SignOutAsync(_configuration["AuthenticationScheme"]);
        ...
        public async Task<User> GetAuthenticatedUserAsync()
        {
            ...
            _signedInUser = await _cacheUserRepository.FindSingleByIdAsync(id, u => u.UserRoles);
        ...
        public User GetAuthenticatedUser()
        {
            ...
            var claimsIdentity = httpContext.User.Identity as ClaimsIdentity;
            long id = Convert.ToInt64(claimsIdentity.Claims.FirstOrDefault(c => c.Type == ClaimTypes.NameIdentifier).Value);
            _signedInUser = _cacheUserRepository.FindSingleById(id, u => u.UserRoles);
            if (_signedInUser == null) throw new MyException("登录信息错误，请重新登录！", 0);
            return _signedInUser;
        }
        /// <summary>
