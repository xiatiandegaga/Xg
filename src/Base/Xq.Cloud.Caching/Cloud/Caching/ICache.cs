...
namespace Cloud.Caching
{
    public interface ICache
    {
        ...
        bool Set(string cacheKey, object value, CachingExpireType cachingExpirationType, bool isAddRandom = true);
        ...
        /// <param name="isAddRandom">是否增加缓存随机时间</param>
        Task<bool> SetAsync(string key, object value, CachingExpireType cachingExpirationType, bool isAddRandom = true);
        ...
        /// <param name="cachingExpirationType">缓存期限类型</param>
        /// <param name="isAddRandom">是否增加缓存随机时间</param>
        bool SetFreeTime(string cacheKey, object value, TimeSpan timeSpan, bool isAddRandom = true);
        ...
        /// <param name="cachingExpirationType">缓存期限类型</param>
        /// <param name="isAddRandom">是否增加缓存随机时间</param>
        Task<bool> SetFreeTimeAsync(string cacheKey, object value, TimeSpan timeSpan, bool isAddRandom = true);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Task<bool> ZAddByTsAsync(string key, long value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Task<bool> ZAddBySortAsync(string key, decimal score, long value);
        /// <summary>
        /// 获取元素的分数
        /// </summary>
        /// <param name="key"></param>
        /// <param name="member"></param>
        /// <returns></returns>
        Task<decimal> ZScoreAsync(string key, long member);
        /// <summary>
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Task<bool> ZRemAsync(string key, long value);
      ...
      Task<long> ZCardAsync(string key);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
       Task<long[]> ZRevRangeAsync(string key, long start = 0, long stop = -1);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
       Task<long[]> ZRangeAsync(string key, long start = 0, long stop = -1);
        ...
        void ZRemAll(Dictionary<string, long> dicKeyValues, int length = 1000);
    }
}
